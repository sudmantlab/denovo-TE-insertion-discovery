...
```
{workdir}/output/alignment/scaffolded/minimap2/standard/variants/graffiti/{specimen}/sniffles/out/3_TSD_search/pangenome_filtered_young_final.vcf
```
